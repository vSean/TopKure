...
if(!file_exists('config.php'))
	exit('<p><b><font style="color:red;">Oops: </font>Top Kure isn\'t installed yet... Installing Top Kure is easy!</b><br/><br/><br/><b><font style="color:#088A08;">Step One: </font><a href="./install.php">Click here to get started!</a></p>' . "\n");
